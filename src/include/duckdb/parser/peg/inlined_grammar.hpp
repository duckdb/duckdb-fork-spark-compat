...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"TypeModifiers <- Parens(List(TypeModifier)?)\n"
	"TypeModifier <- AnyTypeModifier / Expression\n"
	"AnyTypeModifier <- 'ANY'\n"
	...
	"CreateStatementVariation <- CreateTableStmt / CreateMacroStmt / CreateSequenceStmt / CreateTypeStmt / CreateSchemaStmt / CreateViewStmt / CreateViewUsingStmt / CreateIndexStmt / CreateSecretStmt / CreateTriggerStmt\n"
