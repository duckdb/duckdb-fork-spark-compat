...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"TypeVariations <- TimeType / IntervalType / BitType / RowType / VariantType / MapType / ArrayAngleBracketsType / GeometryType / UnionType / NumericType / SetofType / SimpleType\n"
	...
	"PositionArguments <- SingleExpression PositionSeparator SingleExpression\n"
	...
	"CreateStatement <- 'CREATE' OrReplace? GlobalTemporary? Temporary? CreateStatementVariation\n"
	...
	"GlobalTemporary <- 'GLOBAL' ('TEMP' / 'TEMPORARY')\n"
