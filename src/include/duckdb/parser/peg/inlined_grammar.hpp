...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"# Spark's DESCRIBE [EXTENDED|FORMATTED] <table>: must precede ShowQualifiedName so the modifier is matched first\n"
	...
	"JoinClause <- RegularJoinClause / JoinWithoutOnClause / LateralJoinClause\n"
