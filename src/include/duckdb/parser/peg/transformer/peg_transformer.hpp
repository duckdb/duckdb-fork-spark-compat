...
public:
	...
	static bool TransformPivotInList(unique_ptr<ParsedExpression> &expr, PivotColumnEntry &entry, idx_t depth = 0);
	...
	static void InitializePipeExtendClauseTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                 TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	...
	static void InitializePipeDropClauseTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizePipeDropClauseTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	...
	static void InitializePipeOrderByClauseTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                  TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizePipeOrderByClauseTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializePipeLimitOffsetClauseTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                      TransformStackFrame &frame);
	static unique_ptr<TransformResultValue> FinalizePipeLimitOffsetClauseTrampoline(PEGTransformer &transformer,
	                                                                                TransformStack &stack,
	                                                                                TransformStackFrame &frame);
	...
	static unique_ptr<TransformResultValue> TransformPipeExtendClauseInternal(PEGTransformer &transformer,
	                                                                          ParseResult &parse_result);
	...
	TransformPipeSetAssignment(PEGTransformer &transformer, const Identifier &column_name,
	                           unique_ptr<ParsedExpression> expression);
	static unique_ptr<TransformResultValue> TransformPipeDropClauseInternal(PEGTransformer &transformer,
	                                                                        ParseResult &parse_result);
	static unique_ptr<SelectNode> TransformPipeDropClause(PEGTransformer &transformer,
	...
	static unique_ptr<TransformResultValue> TransformPipeOrderByClauseInternal(PEGTransformer &transformer,
	                                                                           ParseResult &parse_result);
	static unique_ptr<SelectNode> TransformPipeOrderByClause(PEGTransformer &transformer,
	                                                         vector<OrderByNode> order_by_clause);
	static unique_ptr<TransformResultValue> TransformPipeLimitOffsetClauseInternal(PEGTransformer &transformer,
	                                                                               ParseResult &parse_result);
	static unique_ptr<SelectNode> TransformPipeLimitOffsetClause(PEGTransformer &transformer,
